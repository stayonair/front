;(function(self) {
  ...
  var Runtime = {
    ...
    addFunction: function(r) {
      for (let e = 0; e < Runtime.functionPointers.length; e++) {
    ...
    getFuncWrapper: function(r, e) {
      ...
      const i = Runtime.funcWrappers[e]
      if (!i[r]) {
        i[r] = function t() {
    ...
    alignMemory: function(r, e) {
      const i = (r = Math.ceil(r / (e ? e : 16)) * (e ? e : 16))
      return i
    },
  ...
  ;(function() {
    const JSfuncs = {
      ...
      arrayToC: function(e) {
        const r = Runtime.stackAlloc(e.length)
    ...
    cwrap = function cwrap(ident, returnType, argTypes) {
      ...
      const numericArgs = argTypes.every(function(e) {
        return e === 'number'
      })
      ...
      const argNames = argTypes.map(function(r, e) {
        return '$' + e
      })
      ...
      const cfuncname = parseJSFunc(function() {
        return cfunc
      }).returnValue
  ...
  function allocate(r, s, c, t) {
    ...
    if (c == ALLOC_NONE) {
      ...
      ][c === undefined ? ALLOC_STATIC : c](Math.max(n, u ? 1 : s.length))
    }
    if (l) {
      var t = e,
        f
    ...
    if (s < 128) {
      ...
      while (e > 0) {
        a = String.fromCharCode.apply(
          String,
          HEAPU8.subarray(r, r + Math.min(e, o))
        )
        t = t ? t + a : a
        r += o
        e -= o
  ...
  function stringToUTF8Array(o, i, e, a) {
    ...
    for (let n = 0; n < o.length; ++n) {
      ...
      if (r >= 55296 && r <= 57343) {
        r = (65536 + ((r & 1023) << 10)) | (o.charCodeAt(++n) & 1023)
      }
      if (r <= 127) {
        if (e >= t) {
          break
  ...
  function lengthBytesUTF8(t) {
    ...
    for (let i = 0; i < t.length; ++i) {
      ...
      if (e >= 55296 && e <= 57343) {
        e = (65536 + ((e & 1023) << 10)) | (t.charCodeAt(++i) & 1023)
      }
      if (e <= 127) {
        ++r
      } else if (e <= 2047) {
  ...
  function stringToUTF16(i, r, e) {
    ...
    e -= 2
    const n = r
    const o = e < i.length * 2 ? e / 2 : i.length
    for (let t = 0; t < o; ++t) {
  ...
  function demangle(r) {
    const s = !!Module.___cxa_demangle
    if (s) {
      try {
    ...
    function c() {
      ...
      while (r[e] !== 'E') {
        if (r[e] === 'S') {
          e++
          const o = r.indexOf('_', e)
          const s = r.substring(e, o) || 0
          i.push(f[s] || '?')
          e = o + 1
          continue
        }
        ...
        const t = parseInt(r.substr(e))
        const n = t.toString().length
        if (!t || !n) {
          e--
          break
        }
        const a = r.substr(e + n, t)
        i.push(a)
        f.push(a)
        e += n + t
      }
  ...
  function intArrayFromString(r, t, i) {
    const n = i > 0 ? i : lengthBytesUTF8(r) + 1
    const e = new Array(n)
    const o = stringToUTF8Array(r, e, 0, e.length)
    if (t) {
      e.length = o
    }
    return e
  ...
  function writeStringToMemory(i, t, n) {
    const r = intArrayFromString(i, n)
    let e = 0
    while (e < r.length) {
      const o = r[e]
      HEAP8[(t + e) >> 0] = o
  ...
  function reSign(e, r, t) {
    ...
    const i = r <= 32 ? Math.abs(1 << (r - 1)) : Math.pow(2, r - 1)
    if (e >= i && (r <= 32 || e > i)) {
      e = -2 * i + e
    }
    return e
  ...
  var PATH = {
    ...
    resolve: function() {
      let e = '',
        r = false
      for (let i = arguments.length - 1; i >= -1 && !r; i--) {
        const t = i >= 0 ? arguments[i] : FS.cwd()
        if (typeof t !== 'string') {
    ...
    relative: function(i, t) {
      ...
      const n = s(i.split('/'))
      const o = s(t.split('/'))
      const f = Math.min(n.length, o.length)
      let a = f
      for (var e = 0; e < f; e++) {
        if (n[e] !== o[e]) {
          a = e
    ...
    default_tty_ops: {
      get_char: function(r) {
        if (!r.input.length) {
          ...
          if (ENVIRONMENT_IS_NODE) {
            const n = 256
            const o = new Buffer(n)
            let i = 0
            let t = process.stdin.fd
            let a = false
            try {
  ...
  var MEMFS = {
    ...
    expandFileStorage: function(e, r) {
      ...
      if (!e.contents || e.contents.subarray) {
        const i = e.contents ? e.contents.buffer.byteLength : 0
        if (i >= r) {
          return
        }
        const t = 1024 * 1024
    ...
    node_ops: {
      ...
      rmdir: function(e, r) {
        const i = FS.lookupNode(e, r)
        for (const t in i.contents) {
          throw new FS.ErrnoError(ERRNO_CODES.ENOTEMPTY)
        }
        delete e.contents[r]
      },
      ...
      symlink: function(r, i, t) {
        const e = MEMFS.createNode(r, i, 511 | 40960, 0)
        e.link = t
        return e
      },
      readlink: function(e) {
    ...
    stream_ops: {
      read: function(t, o, a, s, e) {
        const n = t.node.contents
        if (e >= t.node.usedBytes) {
          return 0
        }
        const r = Math.min(t.node.usedBytes - e, s)
        assert(r >= 0)
        if (r > 8 && n.subarray) {
      ...
      write: function(a, t, i, r, n, s) {
        ...
        if (e.contents.subarray && t.subarray) {
          e.contents.set(t.subarray(i, i + r), n)
        } else {
          for (let o = 0; o < r; o++) {
      ...
      msync: function(e, r, i, t, n) {
        ...
        const o = MEMFS.stream_ops.write(e, r, 0, t, i, false)
        return 0
      }
    }
  }
  var IDBFS = {
    ...
    getLocalSet: function(t, n) {
      ...
      const e = FS.readdir(t.mountpoint)
        .filter(a)
        .map(s(t.mountpoint))
      while (e.length) {
        const r = e.pop()
    ...
    getRemoteSet: function(i, e) {
      ...
      IDBFS.getDB(i.mountpoint, function(i, t) {
        ...
        const n = t.transaction([IDBFS.DB_STORE_NAME], 'readonly')
        n.onerror = function(r) {
          e(this.error)
          r.preventDefault()
        }
        const o = n.objectStore(IDBFS.DB_STORE_NAME)
        const a = o.index('timestamp')
    ...
    reconcile: function(i, r, n) {
      ...
      const c = false
      let l = 0
      const u = i.type === 'remote' ? i.db : r.db
      const f = u.transaction([IDBFS.DB_STORE_NAME], 'readwrite')
      const o = f.objectStore(IDBFS.DB_STORE_NAME)
      function e(r) {
        if (r) {
          if (!e.errored) {
            e.errored = true
  ...
  var NODEFS = {
    ...
    node_ops: {
      ...
      lookup: function(e, r) {
        const i = PATH.join2(NODEFS.realPath(e), r)
        const t = NODEFS.getMode(i)
        return NODEFS.createNode(e, r, t)
      },
      mknod: function(t, n, o, a) {
        const e = NODEFS.createNode(t, n, o, a)
        const i = NODEFS.realPath(e)
        try {
          if (FS.isDir(e.mode)) {
      ...
      rename: function(r, i, t) {
        const n = NODEFS.realPath(r)
        const o = PATH.join2(NODEFS.realPath(i), t)
        try {
          fs.renameSync(n, o)
        } catch (e) {
          if (!e.code) {
      ...
      unlink: function(r, i) {
        const t = PATH.join2(NODEFS.realPath(r), i)
        try {
          fs.unlinkSync(t)
        } catch (e) {
          if (!e.code) {
      ...
      symlink: function(r, i, t) {
        const n = PATH.join2(NODEFS.realPath(r), i)
        try {
          fs.symlinkSync(t, n)
        } catch (e) {
          if (!e.code) {
    ...
    stream_ops: {
      open: function(e) {
        const i = NODEFS.realPath(e.node)
        try {
          if (FS.isFile(e.node.mode)) {
      ...
      write: function(t, n, e, r, o) {
        const a = new Buffer(n.subarray(e, e + r))
        let i
        try {
  ...
  var FS = {
    ...
    lookupPath: function(a, e) {
      ...
      const f = { follow_mount: true, recurse_count: 0 }
      for (const s in f) {
        if (e[s] === undefined) {
          e[s] = f[s]
        }
      ...
      for (let t = 0; t < n.length; t++) {
        ...
        if (!o || e.follow) {
          ...
          while (FS.isLink(r.mode)) {
            const u = FS.readlink(i)
            i = PATH.resolve(PATH.dirname(i), u)
            const c = FS.lookupPath(i, { recurse_count: e.recurse_count })
            r = c.node
            if (l++ > 40) {
              throw new FS.ErrnoError(ERRNO_CODES.ELOOP)
            }
    ...
    hashAddNode: function(e) {
      const r = FS.hashName(e.parent.id, e.name)
      e.name_next = FS.nameTable[r]
      FS.nameTable[r] = e
    },
    hashRemoveNode: function(e) {
      const i = FS.hashName(e.parent.id, e.name)
      if (FS.nameTable[i] === e) {
        FS.nameTable[i] = e.name_next
      } else {
        let r = FS.nameTable[i]
        while (r) {
          if (r.name_next === e) {
    ...
    lookupNode: function(r, i) {
      const t = FS.mayLookup(r)
      if (t) {
        throw new FS.ErrnoError(t, r)
      }
      const n = FS.hashName(r.id, i)
      for (let e = FS.nameTable[n]; e; e = e.name_next) {
        const o = e.name
    ...
    mayLookup: function(e) {
      const r = FS.nodePermissions(e, 'x')
      if (r) {
        return r
      }
      if (!e.node_ops.lookup) {
        return ERRNO_CODES.EACCES
      }
      return 0
    },
    ...
    mayDelete: function(r, t, n) {
      ...
      const i = FS.nodePermissions(r, 'wx')
      if (i) {
        return i
      }
      if (n) {
    ...
    createStream: function(e, n, o) {
      ...
      const r = new FS.FSStream()
      for (const i in e) {
        r[i] = e[i]
      }
      e = r
      const t = FS.nextfd(n, o)
      e.fd = t
      FS.streams[t] = e
      return e
    },
    ...
    chrdev_stream_ops: {
      open: function(e) {
        const r = FS.getDevice(e.node.rdev)
    ...
    syncfs: function(e, i) {
      ...
      const t = FS.getMounts(FS.root.mount)
      let n = 0
      function r(e) {
        if (e) {
          if (!r.errored) {
    ...
    mount: function(o, s, r) {
      ...
      if (n && FS.root) {
        ...
        const a = FS.lookupPath(r, { follow_mount: false })
        r = a.path
        e = a.node
    ...
    unmount: function(n) {
      const r = FS.lookupPath(n, { follow_mount: false })
      if (!FS.isMountpoint(r.node)) {
        throw new FS.ErrnoError(ERRNO_CODES.EINVAL)
      }
      const e = r.node
      const i = e.mounted
      const o = FS.getMounts(i)
      Object.keys(FS.nameTable).forEach(function(r) {
        let e = FS.nameTable[r]
        while (e) {
          const i = e.name_next
      ...
      e.mounted = null
      const t = e.mount.mounts.indexOf(i)
      assert(t !== -1)
    ...
    mknod: function(i, n, o) {
      const a = FS.lookupPath(i, { parent: true })
      const r = a.node
      const e = PATH.basename(i)
      if (!e || e === '.' || e === '..') {
        throw new FS.ErrnoError(ERRNO_CODES.EINVAL)
      }
      const t = FS.mayCreate(r, e)
      if (t) {
    ...
    symlink: function(r, i) {
      ...
      const o = FS.lookupPath(i, { parent: true })
      const e = o.node
      if (!e) {
        throw new FS.ErrnoError(ERRNO_CODES.ENOENT)
      }
      const t = PATH.basename(i)
      const n = FS.mayCreate(e, t)
      if (n) {
    ...
    rename: function(r, t) {
      const h = PATH.dirname(r)
      const m = PATH.dirname(t)
      const d = PATH.basename(r)
      const f = PATH.basename(t)
      let s, e, i
      try {
      ...
      const o = FS.lookupNode(e, d)
      let u = PATH.relative(r, m)
      if (u.charAt(0) !== '.') {
        throw new FS.ErrnoError(ERRNO_CODES.EINVAL)
      }
      u = PATH.relative(t, h)
      ...
      const c = FS.isDir(o.mode)
      let n = FS.mayDelete(e, d, c)
      if (n) {
        throw new FS.ErrnoError(n)
      }
    ...
    rmdir: function(e) {
      const a = FS.lookupPath(e, { parent: true })
      const r = a.node
      const i = PATH.basename(e)
      const t = FS.lookupNode(r, i)
      const n = FS.mayDelete(r, i, true)
      if (n) {
        throw new FS.ErrnoError(n)
      }
      if (!r.node_ops.rmdir) {
    ...
    readdir: function(r) {
      const i = FS.lookupPath(r, { follow: true })
      const e = i.node
    ...
    unlink: function(e) {
      const a = FS.lookupPath(e, { parent: true })
      const r = a.node
      const t = PATH.basename(e)
      const n = FS.lookupNode(r, t)
      let i = FS.mayDelete(r, t, false)
      if (i) {
        if (i === ERRNO_CODES.EISDIR) {
          i = ERRNO_CODES.EPERM
        }
    ...
    stat: function(r, i) {
      const t = FS.lookupPath(r, { follow: !i })
      const e = t.node
      if (!e) {
        throw new FS.ErrnoError(ERRNO_CODES.ENOENT)
      }
    ...
    chmod: function(r, i, t) {
      let e
      if (typeof r === 'string') {
        const n = FS.lookupPath(r, { follow: !t })
        e = n.node
      } else {
        e = r
      }
    ...
    truncate: function(r, i) {
      ...
      let e
      if (typeof r === 'string') {
        const n = FS.lookupPath(r, { follow: true })
        e = n.node
      } else {
        e = r
      }
      ...
      const t = FS.nodePermissions(e, 'w')
      if (t) {
        throw new FS.ErrnoError(t)
      }
    ...
    open: function(r, e, t, u, f) {
      ...
      if (typeof r === 'object') {
        ...
        r = PATH.normalize(r)
        try {
          const c = FS.lookupPath(r, { follow: !(e & 131072) })
          i = c.node
        } catch (l) {}
      }
      let a = false
    ...
    read: function(e, o, a, i, r) {
      ...
      const n = e.stream_ops.read(e, o, a, i, r)
      if (!t) {
        e.position += n
      }
      return n
    ...
    write: function(e, o, a, i, r, s) {
      ...
      const n = e.stream_ops.write(e, o, a, i, r, s)
      if (!t) {
        e.position += n
      }
      try {
    ...
    writeFile: function(n, r, e) {
      ...
      const i = FS.open(n, e.flags, e.mode)
      if (e.encoding === 'utf8') {
        const t = new Uint8Array(lengthBytesUTF8(r) + 1)
        const o = stringToUTF8Array(r, t, 0, t.length)
    ...
    chdir: function(i) {
      const e = FS.lookupPath(i, { follow: true })
      if (!FS.isDir(e.node.mode)) {
        throw new FS.ErrnoError(ERRNO_CODES.ENOTDIR)
      }
      const r = FS.nodePermissions(e.node, 'x')
      if (r) {
    ...
    quit: function() {
      ...
      for (let e = 0; e < FS.streams.length; e++) {
        const r = FS.streams[e]
        if (!r) {
          continue
        }
        FS.close(r)
    ...
    createFolder: function(e, r, i, t) {
      const n = PATH.join2(typeof e === 'string' ? e : FS.getPath(e), r)
      const o = FS.getMode(i, t)
      return FS.mkdir(n, o)
    },
    createPath: function(e, n, o, a) {
      e = typeof e === 'string' ? e : FS.getPath(e)
      const i = n.split('/').reverse()
      while (i.length) {
        const t = i.pop()
        if (!t) {
          continue
    ...
    createDataFile: function(r, a, e, u, l, f) {
      const d = a ? PATH.join2(typeof r === 'string' ? r : FS.getPath(r), a) : r
      const n = FS.getMode(u, l)
      const t = FS.create(d, n)
      if (e) {
        if (typeof e === 'string') {
    ...
    createDevice: function(r, n, i, e) {
      const o = PATH.join2(typeof r === 'string' ? r : FS.getPath(r), n)
      const a = FS.getMode(!!i, !!e)
      if (!FS.createDevice.major) {
        FS.createDevice.major = 64
      }
      const t = FS.makedev(FS.createDevice.major++, 0)
      FS.registerDevice(t, {
        open: function(e) {
          e.seekable = false
        },
    ...
    createLink: function(e, r, i, n, o) {
      const t = PATH.join2(typeof e === 'string' ? e : FS.getPath(e), r)
    ...
    createLazyFile: function(a, l, r, s, f) {
      ...
      t.prototype.get = function c(e) {
        ...
        const r = e % this.chunkSize
        const i = (e / this.chunkSize) | 0
      ...
      t.prototype.cacheLength = function h() {
        ...
        const i = Number(e.getResponseHeader('Content-length'))
        let o
        const a = (o = e.getResponseHeader('Accept-Ranges')) && o === 'bytes'
        let t = 1024 * 1024
        if (!a) {
          t = i
        }
        const s = function(o, n) {
          if (o > n) {
            throw new Error(
              'invalid range (' + o + ', ' + n + ') or no bytes requested!'
            )
          }
          if (n > i - 1) {
            throw new Error('only ' + i + ' bytes available! programmer error!')
          }
          const e = new XMLHttpRequest()
          e.open('GET', r, false)
          if (i !== t) {
            e.setRequestHeader('Range', 'bytes=' + o + '-' + n)
          }
      ...
      const e = FS.createFile(a, l, i, s, f)
      if (i.contents) {
      ...
      const o = {}
      const u = Object.keys(e.stream_ops)
      u.forEach(function(r) {
        const i = e.stream_ops[r]
        o[r] = function t() {
      ...
      o.read = function m(s, o, a, f, t) {
        ...
        const i = s.node.contents
        if (t >= i.length) {
          return 0
        }
        const n = Math.min(i.length - t, f)
        assert(n >= 0)
        if (i.slice) {
          for (var r = 0; r < n; r++) {
            o[a + r] = i[t + r]
    ...
    createPreloadedFile: function(r, o, i, d, c, a, e, l, u, s) {
      Browser.init()
      const n = o ? PATH.resolve(PATH.join2(r, o)) : r
      const t = getUniqueRunDependency('cp ' + n)
      function f(f) {
        function h(e) {
          if (s) {
            s()
    ...
    saveFilesToDB: function(t, i, e) {
      ...
      r.onsuccess = function s() {
        const l = r.result
        const a = l.transaction([FS.DB_STORE_NAME], 'readwrite')
        const u = a.objectStore(FS.DB_STORE_NAME)
        let o = 0,
          n = 0,
          s = t.length
        function f() {
        ...
        t.forEach(function(e) {
          const r = u.put(FS.analyzePath(e).object.contents, e)
    ...
    loadFilesFromDB: function(t, i, e) {
      ...
      r.onsuccess = function a() {
        ...
        const c = a.objectStore(FS.DB_STORE_NAME)
        let o = 0,
          n = 0,
          s = t.length
        function f() {
  ...
  function _emscripten_set_main_loop(e, r, n, i, o) {
    ...
    const t = Browser.mainLoop.currentlyRunningMainloop
    Browser.mainLoop.runner = function a() {
      ...
      if (Browser.mainLoop.queue.length > 0) {
        const a = Date.now()
        const r = Browser.mainLoop.queue.shift()
        r.func(r.arg)
        if (Browser.mainLoop.remainingBlockers) {
          const n = Browser.mainLoop.remainingBlockers
          let o = n % 1 == 0 ? n - 1 : Math.floor(n)
          if (r.counted) {
        ...
        console.log(
          'main loop blocker "' + r.name + '" took ' + (Date.now() - a) + ' ms'
        )
        Browser.mainLoop.updateStatus()
        setTimeout(Browser.mainLoop.runner, 0)
        return
      }
      if (t < Browser.mainLoop.currentlyRunningMainloop) {
        return
      }
  ...
  var Browser = {
    mainLoop: {
      ...
      resume: function() {
        Browser.mainLoop.currentlyRunningMainloop++
        const e = Browser.mainLoop.timingMode
        const r = Browser.mainLoop.timingValue
        const i = Browser.mainLoop.func
      ...
      updateStatus: function() {
        if (Module.setStatus) {
          const i = Module.statusMessage || 'Please wait...'
          const e = Browser.mainLoop.remainingBlockers
          const r = Browser.mainLoop.expectedBlockers
          if (e) {
            if (e < r) {
    ...
    init: function() {
      ...
      i.handle = function a(i, t, o, a) {
        ...
        if (Browser.hasBlobConstructor) {
          try {
            ...
            if (r.size !== i.length) {
              r = new Blob([new Uint8Array(i).buffer], {
        ...
        if (!r) {
          const s = new Browser.BlobBuilder()
          s.append(new Uint8Array(i).buffer)
          r = s.getBlob()
        }
        const n = Browser.URLObject.createObjectURL(r)
        const e = new Image()
        e.onload = function l() {
      ...
      t.handle = function f(t, r, a, o) {
        ...
        if (Browser.hasBlobConstructor) {
          ...
          const l = Browser.URLObject.createObjectURL(f)
          const e = new Audio()
          e.addEventListener(
            'canplaythrough',
            function() {
    ...
    createContext: function(i, e, s, n) {
      if (e && Module.ctx && i == Module.canvas) {
        return Module.ctx
      }
      let r
      let t
      if (e) {
        const o = { antialias: false, alpha: false }
        if (n) {
          for (const a in n) {
            o[a] = n[a]
          }
    ...
    fakeRequestAnimationFrame: function(r) {
      ...
      const i = Math.max(Browser.nextRAF - e, 0)
      setTimeout(r, i)
    },
    ...
    resumeAsyncCallbacks: function() {
      ...
      if (Browser.queuedAsyncCallbacks.length > 0) {
        const e = Browser.queuedAsyncCallbacks
    ...
    calculateMouseEvent: function(e) {
      if (Browser.pointerLock) {
        ...
        const i = Module.canvas.getBoundingClientRect()
        const d = Module.canvas.width
        const l = Module.canvas.height
        const u =
        ...
        if (
          ...
          let a = r.pageX - (u + i.left)
          let s = r.pageY - (c + i.top)
          a = a * (d / i.width)
          s = s * (l / i.height)
          const t = { x: a, y: s }
          if (e.type === 'touchstart') {
            ...
            let f = Browser.touches[r.identifier]
            if (!f) {
              f = t
            }
        ...
        let n = e.pageX - (u + i.left)
        let o = e.pageY - (c + i.top)
        n = n * (d / i.width)
        o = o * (l / i.height)
    ...
    setFullScreenCanvasSize: function() {
      if (typeof SDL != 'undefined') {
        let e = HEAPU32[(SDL.screen + Runtime.QUANTUM_SIZE * 0) >> 2]
        e = e | 8388608
    ...
    updateCanvasDimensions: function(e, t, n) {
      ...
      if (
        ...
        const o = Math.min(screen.width / r, screen.height / i)
        r = Math.round(r * o)
        i = Math.round(i * o)
      }
      if (Browser.resizeCanvas) {
    ...
    getNextWgetRequestHandle: function() {
      const e = Browser.nextWgetRequestHandle
      Browser.nextWgetRequestHandle++
      return e
    }
  }
  const _llvm_sqrt_f64 = Math_sqrt
  function __exit(e) {
    Module.exit(e)
  }
  function _exit(e) {
  ...
  const _atan = Math_atan
  const _BDtoIHigh = true
  ...
  var SOCKFS = {
    ...
    createSocket: function(o, i, e) {
      ...
      const t = SOCKFS.nextname()
      const n = FS.createNode(SOCKFS.root, t, 49152, 0)
      n.sock = r
      const s = FS.createStream({
        path: t,
        node: n,
    ...
    stream_ops: {
      ...
      read: function(i, t, n, o, a) {
        const r = i.node.sock
        const e = r.sock_ops.recvmsg(r, o)
        if (!e) {
          return 0
        }
        t.set(e.buffer, n)
    ...
    websocket_sock_ops: {
      createPeer: function(t, r, n) {
        ...
        if (e) {
          ...
          try {
            const f = Module.websocket && 'object' === typeof Module.websocket
            let i = 'ws:#'.replace('#', '//')
            if (f) {
            ...
            o = o.replace(/^ +| +$/g, '').split(/ *, */)
            const u = ENVIRONMENT_IS_NODE ? { protocol: o.toString() } : o
            const c = ENVIRONMENT_IS_NODE ? require('ws') : window.WebSocket
            e = new c(i, u)
      ...
      handlePeerEvents: function(r, e) {
        ...
        const t = function() {
          ...
          try {
            let i = e.dgram_send_queue.shift()
            while (i) {
              e.socket.send(i)
      ...
      poll: function(r) {
        ...
        const e =
          r.type === 1
            ? SOCKFS.websocket_sock_ops.getPeer(r, r.daddr, r.dport)
            : null
        if (
          r.recv_queue.length ||
          !e ||
      ...
      bind: function(e, i, t) {
        ...
        if (e.type === 2) {
          ...
          try {
            ...
            if (!(r instanceof FS.ErrnoError)) {
              throw r
            }
            if (r.errno !== ERRNO_CODES.EOPNOTSUPP) {
              throw r
            }
          }
        }
      ...
      connect: function(e, t, n) {
        ...
        if (typeof e.daddr !== 'undefined' && typeof e.dport !== 'undefined') {
          const r = SOCKFS.websocket_sock_ops.getPeer(e, e.daddr, e.dport)
          if (r) {
        ...
        const i = SOCKFS.websocket_sock_ops.createPeer(e, t, n)
        e.daddr = i.addr
        e.dport = i.port
      ...
      listen: function(e, t) {
        ...
        const r = require('ws').Server
        const i = e.saddr
        e.server = new r({ host: i, port: e.sport })
        Module.websocket.emit('listen', e.stream.fd)
        e.server.on('connection', function(i) {
          if (e.type === 1) {
            const r = SOCKFS.createSocket(e.family, e.type, e.protocol)
            const t = SOCKFS.websocket_sock_ops.createPeer(r, i)
            r.daddr = t.addr
            r.dport = t.port
            e.pending.push(r)
      ...
      sendmsg: function(r, i, o, a, t, n) {
        ...
        let e = SOCKFS.websocket_sock_ops.getPeer(r, t, n)
        if (r.type === 1) {
          if (
            !e ||
      ...
      recvmsg: function(r, s) {
        ...
        const e = r.recv_queue.shift()
        if (!e) {
          if (r.type === 1) {
            const i = SOCKFS.websocket_sock_ops.getPeer(r, r.daddr, r.dport)
            if (!i) {
              throw new FS.ErrnoError(ERRNO_CODES.ENOTCONN)
            } else if (
        ...
        const n = e.data.byteLength || e.data.length
        const o = e.data.byteOffset || 0
        const a = e.data.buffer || e.data
        const t = Math.min(s, n)
        const f = {
          buffer: new Uint8Array(a, o, t),
          addr: e.addr,
          port: e.port
        }
        if (r.type === 1 && t < n) {
  ...
  function _fwrite(o, e, a, r) {
    ...
    const s = _fileno(r)
    const t = _write(s, o, i)
    if (t == -1) {
      const n = FS.getStreamFromPtr(r)
      if (n) {
        n.error = true
      }
      return 0
  ...
  function __formatString(C, p) {
    ...
    function c(e) {
      ...
      if (e === 'double') {
        r = ((HEAP32[tempDoublePtr >> 2] = HEAP32[(p + l) >> 2]),
      ...
      if (S == 37) {
        ...
        switch (String.fromCharCode(r)) {
          ...
          case 'p': {
            ...
            if (r == 100 || r == 105) {
              if (n == 8 && i64Math) {
                e = i64Math.stringify(h[0], h[1], null)
              } else {
                e = reSign(i, 8 * n, 1).toString(10)
              }
            } else if (r == 117) {
              if (n == 8 && i64Math) {
                e = i64Math.stringify(h[0], h[1], true)
              } else {
                e = unSign(i, 8 * n, 1).toString(10)
              }
              i = Math.abs(i)
            } else if (r == 111) {
              e = (v ? '0' : '') + E.toString(8)
          ...
          case 'G': {
            ...
            if (isNaN(i)) {
              ...
              if (r == 103 || r == 71) {
                A = true
                o = o || 1
                const R = parseInt(i.toExponential(b).split('e')[1], 10)
                if (o > R && R >= -4) {
  ...
  function _fprintf(r, i, t) {
    const e = __formatString(i, t)
    const n = Runtime.stackSave()
    const o = _fwrite(allocate(e, 'i8', ALLOC_STACK), 1, e.length, r)
  ...
  var asm = (function(E, u, C) {
    'use asm'
    const i = new E.Int8Array(C)
    const S = new E.Int16Array(C)
    const e = new E.Int32Array(C)
    const o = new E.Uint8Array(C)
    const Nr = new E.Uint16Array(C)
    const Yn = new E.Uint32Array(C)
    const r = new E.Float32Array(C)
    const f = new E.Float64Array(C)
    let t = u.STACKTOP | 0
    let Ei = u.STACK_MAX | 0
    const n = u.tempDoublePtr | 0
    const bn = u.ABORT | 0
    const ke = u.cttz_i8 | 0
    const vi = u._stderr | 0
    let Er = 0
    let bi = 0
    const sn = 0
    const Jt = 0
    ...
    const Xn = 0
    const Zn = 0
    const x = E.Math.floor
    const p = E.Math.abs
    const ae = E.Math.sqrt
    const d = E.Math.pow
    const N = E.Math.cos
    const Lr = E.Math.sin
    const jn = E.Math.tan
    const qn = E.Math.acos
    const zn = E.Math.asin
    const cr = E.Math.atan
    const Un = E.Math.atan2
    const v = E.Math.exp
    const Ve = E.Math.log
    const hi = E.Math.ceil
    const s = E.Math.imul
    const On = E.Math.min
    const U = E.Math.clz32
    const j = u.abort
    const gn = u.assert
    const kn = u.invoke_iiii
    const Sn = u.invoke_iiiii
    const _n = u.invoke_vii
    const wn = u.invoke_iii
    const hn = u.invoke_viiii
    const fn = u._fabs
    const nn = u._sin
    const rn = u._exp
    const $t = u._llvm_pow_f64
    const Qt = u._send
    const ot = u._VBR_encode_frame
    const a = u._abort
    const Yt = u.___setErrNo
    const at = u._vfprintf
    const ht = u._hip_set_debugf
    const Vt = u._floor
    const _t = u._fflush
    const pn = u._pwrite
    const Ct = u._strerror_r
    const Bt = u.__exit
    const yt = u._GetTitleGain
    const It = u._emscripten_set_main_loop_timing
    const Ht = u._fabsf
    const B = u._sbrk
    const zt = u._atan
    const jt = u._llvm_pow_f32
    const zi = u._InitGainAnalysis
    const Hi = u._emscripten_memcpy_big
    const on = u._fileno
    const vr = u._hip_decode_exit
    const Bi = u._sysconf
    const an = u._cos
    const cn = u._mkport
    const dn = u._floorf
    const gi = u._hip_set_errorf
    const mn = u.__reallyNegative
    const En = u._write
    const vn = u._emscripten_set_main_loop
    const Ye = u._AnalyzeSamples
    const V = u.___errno_location
    const yn = u._log
    const _i = u._init_xrpow_core_sse
    const pi = u._hip_decode1_unclipped
    const Rn = u._fwrite
    const mi = u._time
    const Pn = u._fprintf
    const ci = u._strerror
    const Cn = u._ceil
    const Bn = u.__formatString
    const In = u._sqrt
    const ai = u._hip_set_msgf
    const oi = u._exit
    const ni = u._hip_decode_init
    const xn = u._llvm_sqrt_f64
    const Hn = 0
    function ei(E, se, V, te, fe, Be, Ce, Y, ae) {
      ...
      be = (E + 192) | 0
      if (+r[be >> 2] > 0) {
        N = +r[((e[(E + 85796) >> 2] | 0) + 8) >> 2] * +r[(E + 200) >> 2]
      } else {
        N = 1
      }
      n = z
      ...
      if ((D | 0) > 0) {
        ...
        do {
          ...
          if ((a < s) & (m < h ? (m > a ? m : a) < 4e4 : 0)) {
            e[(z + (M << 4) + 8) >> 2] = 0
          }
          s = +r[pe >> 2]
          if (
            (s < h) &
            (a < s * 1.7000000476837158 ? (a > s ? a : s) < 4e4 : 0)
          ) {
            e[(z + (M << 4) + 12) >> 2] = 0
          }
          n = e[u >> 2] | 0
                  ...
                  do {
                    if (!(a <= 0)) {
                      ...
                      if ((((A | 0) > -1 ? A : (0 - A) | 0) | 0) > (C | 0)) {
                        ...
                        a =
                          +r[
                            (11536 + (~~(+b(m) * 4.816479930623698) << 2)) >> 2
                          ] *
                          (h + a)
                        break
                      } else {
        ...
        if (ee) {
          ...
          do {
            if (le | ((e[(q + ((n & 1) << 2)) >> 2] | 0) == 0)) {
              ...
              e[(E + 26636 + ((n * 244) | 0) + 100 + (k << 2)) >> 2] =
                e[Oe >> 2]
              e[(E + 25660 + ((n * 244) | 0) + 100 + (k << 2)) >> 2] =
                e[Me >> 2]
              e[(E + 26636 + ((n * 244) | 0) + 112 + (k << 2)) >> 2] =
                e[de >> 2]
              e[(E + 25660 + ((n * 244) | 0) + 112 + (k << 2)) >> 2] =
                e[he >> 2]
              e[(E + 26636 + ((n * 244) | 0) + 124 + (k << 2)) >> 2] =
                e[pe >> 2]
              e[(E + 25660 + ((n * 244) | 0) + 124 + (k << 2)) >> 2] = e[B >> 2]
              e[(E + 26636 + ((n * 244) | 0) + 136 + (k << 2)) >> 2] = e[C >> 2]
              e[(E + 25660 + ((n * 244) | 0) + 136 + (k << 2)) >> 2] =
                e[_e >> 2]
              e[(E + 26636 + ((n * 244) | 0) + 148 + (k << 2)) >> 2] =
                e[Re >> 2]
              e[(E + 25660 + ((n * 244) | 0) + 148 + (k << 2)) >> 2] =
                e[Se >> 2]
              e[(E + 26636 + ((n * 244) | 0) + 160 + (k << 2)) >> 2] =
                e[Te >> 2]
              e[(E + 25660 + ((n * 244) | 0) + 160 + (k << 2)) >> 2] =
                e[Fe >> 2]
              e[(E + 26636 + ((n * 244) | 0) + 172 + (k << 2)) >> 2] =
                e[ge >> 2]
              e[(E + 25660 + ((n * 244) | 0) + 172 + (k << 2)) >> 2] =
                e[ke >> 2]
              e[(E + 26636 + ((n * 244) | 0) + 184 + (k << 2)) >> 2] =
                e[Pe >> 2]
              e[(E + 25660 + ((n * 244) | 0) + 184 + (k << 2)) >> 2] =
                e[ce >> 2]
              e[(E + 26636 + ((n * 244) | 0) + 196 + (k << 2)) >> 2] =
                e[qe >> 2]
              e[(E + 25660 + ((n * 244) | 0) + 196 + (k << 2)) >> 2] =
                e[ze >> 2]
              e[(E + 26636 + ((n * 244) | 0) + 208 + (k << 2)) >> 2] =
                e[Ve >> 2]
              e[(E + 25660 + ((n * 244) | 0) + 208 + (k << 2)) >> 2] =
                e[Ue >> 2]
              e[(E + 26636 + ((n * 244) | 0) + 220 + (k << 2)) >> 2] = e[$ >> 2]
              e[(E + 25660 + ((n * 244) | 0) + 220 + (k << 2)) >> 2] = e[F >> 2]
              e[(E + 26636 + ((n * 244) | 0) + 232 + (k << 2)) >> 2] =
                e[He >> 2]
              e[(E + 25660 + ((n * 244) | 0) + 232 + (k << 2)) >> 2] =
                e[xe >> 2]
            }
            n = (n + 1) | 0
          } while ((n | 0) != (G | 0))
          ...
          do {
            ...
            do {
              ...
              e: do {
                if ((_ | 0) == 1) {
                  if (m > 0) {
                    h = +d(+(s / m), 0.18000000715255737) * m
                  } else {
                    h = 0
                  }
                } else {
                  if ((T | 0) == 0 ? (e[C >> 2] | 0) == 3 : 0) {
                    x = 233
                  } else {
                    x = 230
                  }
    ...
    function $r(M) {
      ...
      do {
        ...
        do {
          r[
            (n + 26636 + ((i * 244) | 0) + 88 + (o << 2)) >> 2
          ] = 0x56bc7600000000000
          r[
            (n + 25660 + ((i * 244) | 0) + 88 + (o << 2)) >> 2
          ] = 0x56bc7600000000000
          r[
            (n + 26636 + ((i * 244) | 0) + 100 + (o << 2)) >> 2
          ] = 0x56bc7600000000000
          r[
            (n + 25660 + ((i * 244) | 0) + 100 + (o << 2)) >> 2
          ] = 0x56bc7600000000000
          r[
            (n + 26636 + ((i * 244) | 0) + 112 + (o << 2)) >> 2
          ] = 0x56bc7600000000000
          r[
            (n + 25660 + ((i * 244) | 0) + 112 + (o << 2)) >> 2
          ] = 0x56bc7600000000000
          r[
            (n + 26636 + ((i * 244) | 0) + 124 + (o << 2)) >> 2
          ] = 0x56bc7600000000000
          r[
            (n + 25660 + ((i * 244) | 0) + 124 + (o << 2)) >> 2
          ] = 0x56bc7600000000000
          r[
            (n + 26636 + ((i * 244) | 0) + 136 + (o << 2)) >> 2
          ] = 0x56bc7600000000000
          r[
            (n + 25660 + ((i * 244) | 0) + 136 + (o << 2)) >> 2
          ] = 0x56bc7600000000000
          r[
            (n + 26636 + ((i * 244) | 0) + 148 + (o << 2)) >> 2
          ] = 0x56bc7600000000000
          r[
            (n + 25660 + ((i * 244) | 0) + 148 + (o << 2)) >> 2
          ] = 0x56bc7600000000000
          r[
            (n + 26636 + ((i * 244) | 0) + 160 + (o << 2)) >> 2
          ] = 0x56bc7600000000000
          r[
            (n + 25660 + ((i * 244) | 0) + 160 + (o << 2)) >> 2
          ] = 0x56bc7600000000000
          r[
            (n + 26636 + ((i * 244) | 0) + 172 + (o << 2)) >> 2
          ] = 0x56bc7600000000000
          r[
            (n + 25660 + ((i * 244) | 0) + 172 + (o << 2)) >> 2
          ] = 0x56bc7600000000000
          r[
            (n + 26636 + ((i * 244) | 0) + 184 + (o << 2)) >> 2
          ] = 0x56bc7600000000000
          r[
            (n + 25660 + ((i * 244) | 0) + 184 + (o << 2)) >> 2
          ] = 0x56bc7600000000000
          r[
            (n + 26636 + ((i * 244) | 0) + 196 + (o << 2)) >> 2
          ] = 0x56bc7600000000000
          r[
            (n + 25660 + ((i * 244) | 0) + 196 + (o << 2)) >> 2
          ] = 0x56bc7600000000000
          r[
            (n + 26636 + ((i * 244) | 0) + 208 + (o << 2)) >> 2
          ] = 0x56bc7600000000000
          r[
            (n + 25660 + ((i * 244) | 0) + 208 + (o << 2)) >> 2
          ] = 0x56bc7600000000000
          r[
            (n + 26636 + ((i * 244) | 0) + 220 + (o << 2)) >> 2
          ] = 0x56bc7600000000000
          r[
            (n + 25660 + ((i * 244) | 0) + 220 + (o << 2)) >> 2
          ] = 0x56bc7600000000000
          r[
            (n + 26636 + ((i * 244) | 0) + 232 + (o << 2)) >> 2
          ] = 0x56bc7600000000000
          r[
            (n + 25660 + ((i * 244) | 0) + 232 + (o << 2)) >> 2
          ] = 0x56bc7600000000000
          e[a >> 2] = 0
          o = (o + 1) | 0
        } while ((o | 0) != 3)
        ...
        do {
          ...
          if ((f | 0) > 0) {
            ...
            do {
              w = +d(
                10,
                +((+L(R, +(a | 0) * b * 9.765625e-7 * 1e3) + -20) * 0.1)
              )
              f = e[i >> 2] | 0
              w = +(f | 0) * w
              s = s > w ? w : s
          ...
          r[(B + (E << 2)) >> 2] =
            ...
            +d(
              10,
              +((e[D >> 2] | 0) < 44e3 ? 2.2 : ((s < u ? u : s) + -8) * 0.1)
            )
          E = (E + 1) | 0
        } while ((E | 0) < (e[p >> 2] | 0))
      }
        ...
        if ((a | 0) > 0) {
          ...
          while (1) {
            ...
            if (!(u >= 13)) {
              ...
              s = (24 - u) * -0.75 - (u + -13) * 0.40909090638160706
            }
            ...
            if ((f | 0) > 0) {
              ...
              do {
                w = +d(
                  10,
                  +((+L(R, +(a | 0) * b * 390625e-11 * 1e3) + -20) * 0.1)
                )
                f = e[B >> 2] | 0
                w = +(f | 0) * w
                s = s > w ? w : s
            ...
            r[(E + (_ << 2)) >> 2] =
              ...
              +d(
                10,
                +((e[D >> 2] | 0) < 44e3 ? 2.2 : ((u < m ? m : u) + -8) * 0.1)
              )
            _ = (_ + 1) | 0
            a = e[C >> 2] | 0
            if ((_ | 0) >= (a | 0)) {
      ...
      o = e[(M + 164) >> 2] | 0
      if ((o | 0) < 4) {
        s = -0.7400000095367432
      } else {
        s = +r[(11720 + (o << 2)) >> 2]
        s =
          ((s - +r[(11720 + ((o + 1) << 2)) >> 2]) * +r[(M + 160) >> 2] + s) *
          0.10000000149011612
      }
      if ((i | 0) > 0) {
        a = (i | 0) > 1
    ...
    function ur(c, u, w, E, _, t, h) {
      ...
      if (t > 0) {
        ...
        do {
          ...
          n = +r[d >> 2]
          if (
            !(!(o <= e * 1.5800000429153442) | !(e <= o * 1.5800000429153442))
          ) {
            o = +r[(w + (f << 2)) >> 2]
            e = o * l
            o = o * i
      ...
      do {
        ...
        d = (u + 768 + (a << 2)) | 0
        i = +r[d >> 2]
        if (!(t <= n * 1.5800000429153442) | !(n <= t * 1.5800000429153442)) {
          e = i
        } else {
          e = +r[(w + (a << 2)) >> 2]
          s = e * p
    ...
    function Te(s, o, n, i, w, v) {
      ...
      if ((n | 0) > 0) {
        ...
        while (1) {
          ...
          r[(s + 768 + (i << 2)) >> 2] = +d(
            ...
            +(
              (1 -
                +N(+(o < 15.5 ? o * 0.2026833970057931 : 3.141592653589793))) *
                1.25 +
              -2.5
            )
          )
      ...
      do {
        ...
        r[(s + 1024 + (a << 2)) >> 2] = +d(
          10,
          +(
            (1 - +N(+(o < 15.5 ? o * 0.2026833970057931 : 3.141592653589793))) *
              1.25 +
            -2.5
          )
        )
      ...
      if (p) {
        ...
        do {
          ...
          do {
            ...
            if (!(o <= -60)) {
              o = +v(+((o + d) * 0.23025850929940458)) * 1.5130440282194817
            } else {
              o = 0
            }
              ...
              do {
                ...
                E =
                  +v(
                    +(
                      3.5 -
                      +r[(m + (w << 3) + (i << 2)) >> 2] * 0.0033333333333333335
                    )
                  ) + 1
                if (
                  (e[
                    (n + 304 + ((w * 10504) | 0) + ((i * 5252) | 0) + 4788) >> 2
                  ] |
                    0) ==
                  2
                ) {
      ...
      e: while (1) {
          ...
          while (1) {
            if (_) {
              ...
              while (1) {
                ...
                g =
                  e[
                    (n + 304 + ((a * 10504) | 0) + ((o * 5252) | 0) + 4856) >> 2
                  ] | 0
                if ((g | 0) > 0) {
                  M = (g | 0) > 1
                  i = 0
                ...
                if (
                  (e[
                    (n + 304 + ((a * 10504) | 0) + ((o * 5252) | 0) + 4788) >> 2
                  ] |
                    0) ==
                  2
                    ? ((W =
        ...
        if ((e[R >> 2] | 0) > 0) {
          ...
          do {
            ...
            r[O >> 2] = 0
            w =
              e[(n + 304 + ((S * 10504) | 0) + ((m * 5252) | 0) + 5208) >> 2] |
              0
            ...
            if (+r[O >> 2] > 9.999999682655225e-21) {
              ...
              if (i) {
                ...
                if ((f | 0) == 2) {
                  l(
                    (n + 304 + ((S * 10504) | 0) + ((m * 5252) | 0) + 2304) | 0,
                    F | 0,
                    2304
                  ) | 0
                }
        ...
        do {
          if ((o | 0) > 0) {
            ...
            do {
              ...
              v =
                e[
                  (i + 304 + ((u * 10504) | 0) + ((a * 5252) | 0) + 5208) >> 2
                ] | 0
              r[
                (i + 304 + ((u * 10504) | 0) + ((a * 5252) | 0) + 4764) >> 2
              ] = 0
              c(
                (F + ((u * 4608) | 0) + ((a * 2304) | 0) + (v << 2)) | 0,
                0,
                ((576 - v) << 2) | 0
              ) | 0
              H[e[h >> 2] & 7](
              ...
              if (+r[b >> 2] > 9.999999682655225e-21) {
                ...
                c(
                  (i + 304 + ((u * 10504) | 0) + ((a * 5252) | 0) + 2304) | 0,
                  0,
                  2304
                ) | 0
                e[(k + (u << 3) + (a << 2)) >> 2] = 0
          ...
          if (L) {
            ...
            do {
              ...
              if (w > 700) {
                ...
                o = ((o | 0) < (f | 0)
                ? (e[
                    (n + 304 + ((v * 10504) | 0) + ((i * 5252) | 0) + 4788) >> 2
                  ] |
                    0) ==
                  2
                : 0)
            ...
            do {
              ...
              if ((e[R >> 2] | 0) > 0) {
                ...
                do {
                  ...
                  E =
                    e[
                      (n + 304 + ((a * 10504) | 0) + ((i * 5252) | 0) + 5208) >>
                        2
                    ] | 0
                  r[
                    (n + 304 + ((a * 10504) | 0) + ((i * 5252) | 0) + 4764) >> 2
                  ] = 0
          ...
          do {
            ...
            r[F >> 2] = +d(
              ...
              +(
                +r[
                  ((e[
                    (i + 304 + ((n * 10504) | 0) + ((o * 5252) | 0) + 4788) >> 2
                  ] |
                    0) ==
                  2
                    ? O
            ...
            r[_ >> 2] = 0
            a =
              e[(i + 304 + ((n * 10504) | 0) + ((o * 5252) | 0) + 5208) >> 2] |
              0
            ...
            if (+r[_ >> 2] > 9.999999682655225e-21) {
              ...
              c(
                (i + 304 + ((n * 10504) | 0) + ((o * 5252) | 0) + 2304) | 0,
                0,
                2304
              ) | 0
            }
      ...
      do {
        ...
        e: do {
          if (!(+r[u >> 2] >= 1)) {
            ...
            } else if (i <= i * 9.999999974752427e-7) {
              break
            }
            _ = (1 - +r[u >> 2]) * +r[(v + (d << 2)) >> 2]
            n = 0
            ...
            if (n) {
              ...
              } else if (o <= o * 9.999999974752427e-7) {
                break
              }
              while (1) {
                n = (c - a) | 0
    ...
    function zr(t) {
      ...
      do {
        ...
        if ((o | 0) < (l | 0)) {
          do {
            ...
            s = +d(
              10,
              +((+r[p >> 2] + h + (s > 0 ? -s : -100)) * 0.10000000149011612)
            )
            h = +r[a >> 2]
            r[a >> 2] = h < s ? h : s
            o = (o + 1) | 0
      ...
      do {
        ...
        if ((a | 0) < (f | 0)) {
          do {
            ...
            i = +d(
              10,
              +((+r[p >> 2] + s + (i > 0 ? -i : -100)) * 0.10000000149011612)
            )
            s = +r[u >> 2]
            i = s < i ? s : i
            r[u >> 2] = i
      ...
      i =
        +Mr(
          +d(
            10,
            +((+r[p >> 2] + m + (i > 0 ? -i : -100)) * 0.10000000149011612)
          )
        ) * 10
      r[((e[E >> 2] | 0) + 20) >> 2] = i
      r[3510] = 0
    ...
    function ye(e, r, i, t) {
      ...
      if (e > 9.999999682655225e-21) {
        e = +b(e) * 0.03333343265598758 + 1
      } else {
        e = 0
      }
      return +(+d(
    ...
    function J(S, v, h, f) {
      ...
      if ((e[O >> 2] | 0) > 0) {
        ...
        while (1) {
          ...
          if (t > 9.999999682655225e-21) {
            l = +b(t) * 0.03333343265598758 + 1
          } else {
            l = 0
          }
          l = +d(
          ...
          l = +r[(v + 244 + (a << 2)) >> 2]
          if (
            l > 9.999999960041972e-13
              ? ((u = M * ((+r[(v + (a << 2)) >> 2] * o) / l)), t < u)
              : 0
          ) {
            t = u
          }
      ...
      a = 575
      while (1) {
        if (+p(+(+r[(h + (a << 2)) >> 2])) > 9.999999960041972e-13) {
          break
        }
        if ((a | 0) > 1) {
          a = (a + -1) | 0
      ...
      if (
        (e[(S + 85092) >> 2] | 0) == 0
          ? ((k = e[(S + 64) >> 2] | 0), (k | 0) < 44e3)
          : 0
      ) {
        f = (k | 0) < 8001
        if (s) {
          f = ((e[(S + 21452 + ((f ? 9 : 12) << 2)) >> 2] | 0) * 3) | 0
        } else {
          f = e[(S + 21360 + ((f ? 17 : 21) << 2)) >> 2] | 0
        }
        y = (f + -1) | 0
        a = (a | 0) > (y | 0) ? y : a
      }
      ...
      while (1) {
        ...
        if (o > 9.999999682655225e-21) {
          n = +b(o) * 0.03333343265598758 + 1
        } else {
          n = 0
        }
        u = +d(
        ...
        if ((k | 0) > 0) {
          ...
          t = (n < 0
          ? +r[(v + 332 + ((_ * 12) | 0)) >> 2] > 9.999999960041972e-13
          : 0)
            ? 0
            : n
          t = t > 2.220446049250313e-16 ? t : 2.220446049250313e-16
          ...
          r[w >> 2] = t
          t = (n < 0
          ? +r[(v + 332 + ((_ * 12) | 0) + 4) >> 2] > 9.999999960041972e-13
          : 0)
            ? 0
            : n
          t = t > 2.220446049250313e-16 ? t : 2.220446049250313e-16
          ...
          r[(w + 4) >> 2] = t
          n = (n < 0
          ? +r[(v + 332 + ((_ * 12) | 0) + 8) >> 2] > 9.999999960041972e-13
          : 0)
            ? 0
            : n
      ...
      while (1) {
        ...
        do {
          if ((d | 0) == 8) {
            ...
            do {
              if ((u | 0) > (e[U >> 2] | 0)) {
                ...
                while (1) {
                  ...
                  F =
                    F -
                    +r[(14040 + (e[(n + 2304 + (i << 2)) >> 2] << 2)) >> 2] * o
                  S = (i + 1) | 0
                  h = +p(+(+r[(n + (S << 2)) >> 2]))
                  h =
                    h -
                    +r[(14040 + (e[(n + 2304 + (S << 2)) >> 2] << 2)) >> 2] * o
                  a = F * F + a + h * h
                  if (!l) {
                    break
                  } else {
            ...
            a = a * y
            o =
              +b(a > 9.999999682655225e-21 ? a : 9.999999682655225e-21) *
              0.30102999566398114
            if (N) {
              r[(_ + 320 + (c << 2)) >> 2] = o
              f = e[C >> 2] | 0
      ...
      do {
        if ((d | 0) > 0) {
          ...
          do {
            ...
            R =
              (e[(u + 304 + ((o * 10504) | 0) + ((i * 5252) | 0) + 4836) >> 2] |
                0) ==
              0
                ? 0.5
                : 1
            ...
            Fe(p, k, O, F, 0) | 0
            d =
              e[(u + 304 + ((o * 10504) | 0) + ((i * 5252) | 0) + 4848) >> 2] |
              0
            y =
              (e[(u + 304 + ((o * 10504) | 0) + ((i * 5252) | 0) + 4788) >> 2] |
                0) ==
              2
            if (
              !y
                ? (e[
                    (u + 304 + ((o * 10504) | 0) + ((i * 5252) | 0) + 4792) >> 2
                  ] |
                    0) ==
                  0
                : 0
            ...
            if ((I | 0) == 13) {
              ...
              A =
                (e[
                  (u + 304 + ((o * 10504) | 0) + ((i * 5252) | 0) + 4832) >> 2
                ] |
                  0) !=
                0
              S = e[ee >> 2] | 0
              ...
              do {
                ...
                h = h / n
                f[
                  (m + 190712 + ((o * 704) | 0) + ((i * 176) | 0) + (c << 3)) >>
                    3
                ] = h * 999999986991104
                f[
                  (m + 201208 + ((o * 352) | 0) + ((i * 176) | 0) + (c << 3)) >>
                    3
                ] =
                  (+r[(k + (c << 2)) >> 2] *
                    999999986991104 *
                ...
                n =
                  +r[(_ + ((o * 976) | 0) + ((i * 488) | 0) + (c << 2)) >> 2] *
                  h
                h = +r[(P + 24 + (c << 2)) >> 2]
                f[
                  (m + 189304 + ((o * 704) | 0) + ((i * 176) | 0) + (c << 3)) >>
                    3
                ] = (n > h ? n : h) * 999999986991104
                a =
                  (m + 199160 + ((o * 352) | 0) + ((i * 176) | 0) + (c << 3)) |
                  0
                f[a >> 3] = 0
                if (A & ((c | 0) > 10)) {
                  h = -(R * +(e[(12112 + (c << 2)) >> 2] | 0))
            ...
            if (
              ...
              while (1) {
                ...
                if ((T | 0) <= (A | 0)) {
                  ...
                  if (L ? (e[B >> 2] | 0) == 0 : 0) {
                    n = n > 0 ? 9.999999682655225e-21 / n : 0
                  } else {
                    n = 0
                  }
                  n =
            ...
            e[(d + 203400 + (o << 3) + (i << 2)) >> 2] =
              (e[c >> 2] | 0) +
              (e[(u + 304 + ((o * 10504) | 0) + ((i * 5252) | 0) + 4768) >> 2] |
                0)
    ...
    function le(r, i) {
      ...
      r = (r + 52140) | 0
      e[r >> 2] =
        (e[r >> 2] | 0) - ((e[(i + 4844) >> 2] | 0) + (e[(i + 4768) >> 2] | 0))
      return
    }
    function P(i, t) {
      i = i | 0
    ...
    function mr(l, a, p) {
      ...
      while (1) {
        ...
        if (
          !(
            e[(a + 2304 + (r << 2)) >> 2] | e[(a + 2304 + ((n + -1) << 2)) >> 2]
          )
        ) {
          n = r
        } else {
      ...
      if ((r | 0) > 0) {
        e[(a + 4796) >> 2] =
          y[e[(l + 85816) >> 2] & 3](c, (a + 2304 + (r << 2)) | 0, u) | 0
      }
      if ((r | 0) < (n | 0)) {
        e[(a + 4800) >> 2] =
          y[e[(l + 85816) >> 2] & 3](
    ...
    function oe(p, r) {
      ...
      if (!(e[(u + 4788) >> 2] | 0)) {
        ...
        if ((n | 0) > 0) {
          e[(u + 4796) >> 2] =
            y[e[(p + 85816) >> 2] & 3](g, (r + 2304 + (n << 2)) | 0, i) | 0
        }
        if ((s | 0) > (n | 0)) {
          e[(u + 4800) >> 2] =
            y[e[(p + 85816) >> 2] & 3](
    ...
    function Oe(g, d, n, t) {
      ...
      if ((f | 0) > 0) {
        ...
        do {
          r =
            e[
              (t + ((d * 10504) | 0) + ((n * 5252) | 0) + 4872 + (o << 2)) >> 2
            ] | 0
          u = m
          m = (r + m) | 0
          e: do {
          ...
          if ((u | 0) == (m | 0)) {
            e[
              (t + ((d * 10504) | 0) + ((n * 5252) | 0) + 4608 + (o << 2)) >> 2
            ] = -2
            f = e[w >> 2] | 0
            i = -2
          }
      ...
      if (
        ...
        do {
          o =
            e[
              (t + ((d * 10504) | 0) + ((n * 5252) | 0) + 4608 + (m << 2)) >> 2
            ] | 0
          u = ((o | 0) > 0 ? o : 0) | u
          m = (m + 1) | 0
        } while ((m | 0) < (f | 0))
        if (((u | 0) != 0) & (((u & 1) | 0) == 0)) {
          if (l) {
            ...
            do {
              u =
                (t + ((d * 10504) | 0) + ((n * 5252) | 0) + 4608 + (o << 2)) | 0
              m = e[u >> 2] | 0
              if ((m | 0) > 0) {
                e[u >> 2] = m >> 1
                f = e[w >> 2] | 0
    ...
    function We(w, i) {
      ...
      if (!d) {
        ...
        h = s(e[c >> 2] | 0, l) | 0
        h =
          ((s(e[(11824 + ((m * 48) | 0) + (u << 4) + 4) >> 2] | 0, r) | 0) +
            h) |
          0
        h =
          (h +
            (s(e[(11824 + ((m * 48) | 0) + (u << 4) + 8) >> 2] | 0, f) | 0)) |
          0
        e[(i + 4844) >> 2] =
          h + (s(e[(11824 + ((m * 48) | 0) + (u << 4) + 12) >> 2] | 0, n) | 0)
      }
      h = d
      t = v
      return h | 0
    ...
    function ne(a, i, s, t) {
      ...
      if (!l) {
        ...
        while (1) {
          ...
          c =
            +r[
              (46872 +
                ((((r[n >> 2] = c), e[n >> 2] | 0) + -1258291200) << 2)) >>
                2
            ] + c
          u =
            +r[
              (46872 +
                ((((r[n >> 2] = u), e[n >> 2] | 0) + -1258291200) << 2)) >>
                2
            ] + u
          d =
            +r[
              (46872 +
                ((((r[n >> 2] = d), e[n >> 2] | 0) + -1258291200) << 2)) >>
                2
            ] + d
          o =
            +r[
              (46872 +
                ((((r[n >> 2] = o), e[n >> 2] | 0) + -1258291200) << 2)) >>
                2
            ] + o
      ...
      o =
        +r[
          (46872 + ((((r[n >> 2] = o), e[n >> 2] | 0) + -1258291200) << 2)) >> 2
        ] + o
      i =
        +r[
          (46872 + ((((r[n >> 2] = i), e[n >> 2] | 0) + -1258291200) << 2)) >> 2
        ] + i
    ...
    function F(e) {
      ...
      e = e < 0 ? 0 : e * 0.001
      return +(
        +cr(+(e * e * 0.017777777777777778)) * 3.5 +
        +cr(+(e * 0.76)) * 13
      )
    }
    function ie(n, i, r) {
    ...
    function pr(c, A, C, E, D, T) {
      ...
      i = e[H >> 2] | 0
      if (
        (i | 0) >= (~~(a * 0.9994999766349792) | 0)
          ? (~~(a * 1.000499963760376) | 0) >= (i | 0)
          : 0
      ) {
        o = (L | 0) < (E | 0) ? L : E
        i = o << 2
    ...
    function Zi() {
      ...
      do {
        r[(89648 + (i << 2)) >> 2] =
          +Ve(+(+(i | 0) * 0.001953125 + 1)) * 1.4426950408889634
        i = (i + 1) | 0
      } while ((i | 0) != 513)
      e[22410] = 1
      return
    ...
    function lt(i) {
      ...
      let r = 0,
        ...
        o = 0
      a =
        e[(83944 + (e[(i + 16) >> 2] << 6) + (e[(i + 84744) >> 2] << 2)) >> 2] |
        0
      n = (i + 85784) | 0
      e[n >> 2] = (e[n >> 2] | 0) + 1
      n = (i + 85760) | 0
    ...
    function pt(r) {
      ...
      i = (i | 0) == 0 ? 255 : (i + -1) | 0
      a =
        ((e[(r + 39840 + ((i * 48) | 0)) >> 2] | 0) - (e[(r + 292) >> 2] | 0)) |
        0
      if ((a | 0) > -1) {
        o = (i + (1 - n)) | 0
        a =
          ...
          do {
            if ((n | 0) > 0) {
              ...
              while (1) {
                d =
                  ((e[
                    (u + 304 + ((p * 10504) | 0) + ((m * 5252) | 0) + 4844) >> 2
                  ] |
                    0) +
                    (e[
                      (u + 304 + ((p * 10504) | 0) + ((m * 5252) | 0) + 4768) >>
                        2
                    ] |
                      0)) |
                  0
                ...
                d =
                  ((e[
                    (u + 304 + ((p * 10504) | 0) + ((m * 5252) | 0) + 4772) >> 2
                  ] |
                    0) /
                    2) |
                  0
                ...
                d =
                  e[
                    (u + 304 + ((p * 10504) | 0) + ((m * 5252) | 0) + 4780) >> 2
                  ] | 0
                a = 8
                do {
                  h = (8 - (n & 7)) | 0
                ...
                d =
                  e[
                    (u + 304 + ((p * 10504) | 0) + ((m * 5252) | 0) + 4784) >> 2
                  ] | 0
                a = 4
                do {
                  h = (8 - (n & 7)) | 0
                ...
                if (!(e[d >> 2] | 0)) {
                  ...
                  e[a >> 2] = n
                  d =
                    (u + 304 + ((p * 10504) | 0) + ((m * 5252) | 0) + 4796) | 0
                  a = e[d >> 2] | 0
                  if ((a | 0) == 14) {
                    e[d >> 2] = 16
                    r = e[w >> 2] | 0
                  ...
                  e[(u + 39840 + ((r * 48) | 0) + 4) >> 2] = n
                  d =
                    (u + 304 + ((p * 10504) | 0) + ((m * 5252) | 0) + 4800) | 0
                  a = e[d >> 2] | 0
                  if ((a | 0) == 14) {
                    e[d >> 2] = 16
                    r = e[w >> 2] | 0
                  ...
                  e[(u + 39840 + ((r * 48) | 0) + 4) >> 2] = n
                  d =
                    (u + 304 + ((p * 10504) | 0) + ((m * 5252) | 0) + 4804) | 0
                  a = e[d >> 2] | 0
                  if ((a | 0) == 14) {
                    e[d >> 2] = 16
                    r = e[w >> 2] | 0
                ...
                d =
                  e[
                    (u + 304 + ((p * 10504) | 0) + ((m * 5252) | 0) + 4832) >> 2
                  ] | 0
                a = 1
                do {
                  h = (8 - (n & 7)) | 0
                ...
                d =
                  e[
                    (u + 304 + ((p * 10504) | 0) + ((m * 5252) | 0) + 4836) >> 2
                  ] | 0
                a = 1
                do {
                  h = (8 - (n & 7)) | 0
                ...
                d =
                  e[
                    (u + 304 + ((p * 10504) | 0) + ((m * 5252) | 0) + 4840) >> 2
                  ] | 0
                a = 1
                do {
                  h = (8 - (n & 7)) | 0
        ...
        if ((e[A >> 2] | 0) == 1) {
          ...
          do {
            if ((d | 0) > 0) {
              ...
              do {
                ...
                D =
                  e[
                    (u + 304 + ((b * 10504) | 0) + ((S * 5252) | 0) + 4784) >> 2
                  ] | 0
                R = e[(88648 + (D << 2)) >> 2] | 0
                D = e[(88712 + (D << 2)) >> 2] | 0
                ...
                if (
                  (e[
                    (u + 304 + ((b * 10504) | 0) + ((S * 5252) | 0) + 4788) >> 2
                  ] |
                    0) ==
                  2
                ) {
                  h = ((e[x >> 2] | 0) * 3) | 0
                  f =
                    (u + 304 + ((b * 10504) | 0) + ((S * 5252) | 0) + 4772) | 0
                  a = e[f >> 2] | 0
                  h = (h | 0) > (a | 0) ? a : h
                  a =
                    O(
                  ...
                  a =
                    e[
                      (u + 304 + ((b * 10504) | 0) + ((S * 5252) | 0) + 4772) >>
                        2
                    ] | 0
                  f =
                    e[
                      (u + 304 + ((b * 10504) | 0) + ((S * 5252) | 0) + 4824) >>
                        2
                    ] | 0
          ...
          do {
            ...
            if ((e[(u + 304 + ((A * 5252) | 0) + 4788) >> 2] | 0) == 2) {
              ...
              F = (F | 0) > (d | 0) ? d : F
              d =
                O(u, e[(u + 304 + ((A * 5252) | 0) + 4796) >> 2] | 0, 0, F, H) |
                0
              d =
                ((O(
                  u,
                  e[(u + 304 + ((A * 5252) | 0) + 4800) >> 2] | 0,
                  F,
                  e[b >> 2] | 0,
                  H
                ) |
              ...
              b = (b | 0) > (d | 0) ? d : b
              F =
                O(u, e[(u + 304 + ((A * 5252) | 0) + 4796) >> 2] | 0, 0, S, H) |
                0
              F =
                ((O(
                  u,
    ...
    function sr(a, g, A, G, Y) {
        ...
        if ((i | 0) > 0) {
          ...
          do {
            if ((o | 0) > 0) {
              ...
              do {
                e[
                  (a + 304 + ((d * 10504) | 0) + ((i * 5252) | 0) + 4788) >> 2
                ] = 2
                i = (i + 1) | 0
                o = e[w >> 2] | 0
              } while ((i | 0) < (o | 0))
        ...
        if ((o | 0) > 0) {
          ...
          while (1) {
            ...
            if ((o | 0) > 0) {
              ...
              do {
                e[
                  (a + 304 + ((u * 10504) | 0) + ((i * 5252) | 0) + 4788) >> 2
                ] = e[(y + (i << 2)) >> 2]
                e[
                  (a + 304 + ((u * 10504) | 0) + ((i * 5252) | 0) + 4792) >> 2
                ] = 0
                i = (i + 1) | 0
              } while ((i | 0) < (o | 0))
            }
      ...
      if (
        (e[D >> 2] | 0) != 0 ? ((z = e[(a + 85804) >> 2] | 0), (z | 0) != 0) : 0
      ) {
        d = ((e[S >> 2] | 0) * 576) | 0
        i = e[(a + 72) >> 2] | 0
        if ((i | 0) > 0) {
      ...
      do {
        if ((w | 0) > 0) {
          ...
          do {
            w =
              (e[(a + 304 + ((o * 10504) | 0) + ((m * 5252) | 0) + 4792) >> 2] |
                0) ==
              0
                ? e[
                    (a + 304 + ((o * 10504) | 0) + ((m * 5252) | 0) + 4788) >> 2
                  ] | 0
                : 4
    ...
    function Mt(i, E, _, p) {
      ...
      while (1) {
        ...
        while (1) {
          ...
          n =
            +r[(i + ((l + 128) << 2)) >> 2] * +r[(1848 + ((127 - a) << 2)) >> 2]
          t = u - n
          u = n + u
          n = +r[(i + ((l + 64) << 2)) >> 2] * +r[(1848 + ((a + 64) << 2)) >> 2]
          h =
            +r[(i + ((l + 192) << 2)) >> 2] * +r[(1848 + ((63 - a) << 2)) >> 2]
          f = n - h
          n = h + n
          c = d
          d = (d + -16) | 0
          ...
          t =
            +r[(i + ((l + 129) << 2)) >> 2] * +r[(1848 + ((126 - a) << 2)) >> 2]
          n = f - t
          f = t + f
          t = +r[(i + ((l + 65) << 2)) >> 2] * +r[(1848 + ((a + 65) << 2)) >> 2]
          u =
            +r[(i + ((l + 193) << 2)) >> 2] * +r[(1848 + ((62 - a) << 2)) >> 2]
          h = t - u
          t = u + t
          r[(c + 496) >> 2] = t + f
          r[(c + 504) >> 2] = f - t
    ...
    function Ot(t) {
      ...
      do {
        ...
        r[(2360 + (i << 2)) >> 2] =
          0.42 -
          +N(+(n * 0.006135923151542565)) * 0.5 +
          +N(+(n * 0.01227184630308513)) * 0.08
        i = (i + 1) | 0
      } while ((i | 0) != 1024)
      i = 0
      do {
        r[(1848 + (i << 2)) >> 2] =
          (1 - +N(+((+(i | 0) + 0.5) * 0.02454369260617026))) * 0.5
        i = (i + 1) | 0
      } while ((i | 0) != 128)
      e[(t + 85820) >> 2] = 1
      return
    ...
    function Pt(r, a, u, d, w) {
      ...
      if (d) {
        ...
        if (
          (t | 0) != 0 ? ((s = k(o, 1) | 0), (e[r >> 2] = s), (s | 0) != 0) : 0
        ) {
          l(s | 0, d | 0, t | 0) | 0
          i[(s + t) >> 0] = 0
        } else {
      ...
      if (w) {
        ...
        if (
          (t | 0) != 0 ? ((m = k(o, 1) | 0), (e[r >> 2] = m), (m | 0) != 0) : 0
        ) {
          l(m | 0, w | 0, t | 0) | 0
          i[(m + t) >> 0] = 0
        } else {
    ...
    function At(f) {
      ...
      if (((a | 0) == 4) | ((a | 0) == 1)) {
        ...
        a = e[(f + 168) >> 2] | 0
        if ((a | 0) != 128 ? ((m = (f + 96) | 0), (e[m >> 2] | 0) == 0) : 0) {
          e[m >> 2] = a
        }
        S = (o + 152) | 0
        e[S >> 2] = e[(f + 56) >> 2]
        ...
        do {
          if (!(e[w >> 2] | 0)) {
            ...
            } else if (!(E <= E * 9.999999974752427e-7)) {
              break
            }
        ...
        if (l > 0) {
          ...
          e[(o + 20) >> 2] = _r(m, P) | 0
          if (!(e[S >> 2] | 0)) {
            e[w >> 2] = ie(e[w >> 2] | 0, e[P >> 2] | 0, e[u >> 2] | 0) | 0
          }
        }
      } else {
        e[(f + 56) >> 2] = 0
      ...
      if (!a) {
        switch (e[M >> 2] | 0) {
          case 0: {
            l = +(
              e[(6776 + ((Ue(e[(f + 96) >> 2] & 65535) | 0) << 3) + 4) >> 2] | 0
            )
            break
          }
          case 3: {
            l = +(
              e[(6776 + ((Ue(e[(f + 168) >> 2] & 65535) | 0) << 3) + 4) >> 2] |
              0
            )
            break
          }
      ...
      if ((h | 0) > 0 ? (h | 0) < (((u | 0) / 2) | 0 | 0) : 0) {
        ...
        if (_ > 0) {
          ...
          r[T >> 2] =
            (+(((i | 0) == 999 ? a : i) | 0) + -0.75) * 0.03225806451612903
    ...
    function kt(l, d, u) {
      ...
      if ((r | 0) > 0) {
        ...
        do {
          ...
          r = (r | 0) > 1152 ? 1152 : r
          r =
            Qe(l, h, f, (r | 0) < 1 ? 1 : r, d, b ? 0 : (u - a) | 0, 0, 1, 1) |
            0
          d = (d + r) | 0
          a = (r + a) | 0
          S = w
    ...
    function mt(i) {
      ...
      do {
        if (e[(i + 128) >> 2] | 0) {
          ...
          t = +p(+(t + 24601))
          if (o > 24601) {
            if (!(t <= o * 9.999999974752427e-7)) {
              n = 5
            } else {
              n = 6
            }
          } else if (!(t <= 0.024600999937888446)) {
            n = 5
          } else {
            n = 6
          }
              ...
              do {
                if (!(a < 1e-12)) {
                  ...
                  if ((O | 0) == 2) {
                    ...
                    m = +r[C >> 2] + m * 0.5
                    a =
                      E * 0.6427876353263855 +
                      S * 0.9848077297210693 +
                      g * 0.3420201539993286 +
                      _
                    y =
                      v * 0.7660444378852844 +
                      d * 0.1736481785774231 +
                      p * 0.9396926164627075 +
                      m
                    r[(c + 4) >> 2] = a + y
                    r[(c + 8) >> 2] = a - y
                    y =
                      S * 0.6427876353263855 -
                      E * 0.3420201539993286 +
                      g * 0.9848077297210693 -
                      _
                    a =
                      d * 0.7660444378852844 -
                      v * 0.9396926164627075 -
                      p * 0.1736481785774231 +
                      m
                    r[(c + 36) >> 2] = y + a
                    r[(c + 40) >> 2] = y - a
                    _ =
                      E * 0.9848077297210693 +
                      S * 0.3420201539993286 -
                      g * 0.6427876353263855 -
                      _
                    m =
                      d * 0.9396926164627075 -
                      v * 0.1736481785774231 +
                      p * 0.7660444378852844 -
                      m
                    r[(c + 52) >> 2] = m + _
                    r[(c + 56) >> 2] = _ - m
                    m = +r[K >> 2] - +r[w >> 2]
                    ...
                    E =
                      v * 0.9396926164627075 -
                      g * 0.1736481785774231 -
                      S * 0.7660444378852844 -
                      d
                    y =
                      _ * 0.9848077297210693 +
                      m * 0.3420201539993286 +
                      p * 0.6427876353263855 +
                      a
                    r[(c + 12) >> 2] = E + y
                    r[(c + 16) >> 2] = E - y
                    y =
                      v * 0.7660444378852844 -
                      g * 0.9396926164627075 +
                      S * 0.1736481785774231 +
                      d
                    E =
                      m * 0.6427876353263855 -
                      _ * 0.3420201539993286 -
                      p * 0.9848077297210693 +
                      a
                    r[(c + 28) >> 2] = y + E
                    r[(c + 32) >> 2] = y - E
                    d =
                      g * 0.7660444378852844 +
                      v * 0.1736481785774231 -
                      S * 0.9396926164627075 +
                      d
                    a =
                      _ * 0.6427876353263855 +
                      m * 0.9848077297210693 -
                      p * 0.3420201539993286 -
                      a
                    r[(c + 60) >> 2] = d + a
                    r[(c + 64) >> 2] = d - a
                    break
    ...
    function Ar(t, a, n) {
      ...
      i = +fr(t)
      if ((i != i) | (0 != 0) | (i == 0)) {
        pe(t, +r[(10560 + ((o * 52) | 0) + 32) >> 2]) | 0
      }
      i = +ar(t)
      if ((i != i) | (0 != 0) | (i == 0)) {
        we(t, +r[(10560 + ((o * 52) | 0) + 32) >> 2] * 1.1) | 0
      }
      i = +ir(t)
      if ((i != i) | (0 != 0) | (i == 0)) {
        he(t, +r[(10560 + ((o * 52) | 0) + 36) >> 2]) | 0
    ...
    function A(i, n, y) {
      ...
      if ((v | 0) > 0 ? ((g = Ee(i) | 0), ((g & 66060288) | 0) == 0) : 0) {
        ve(i, g | (v << 20)) | 0
      }
      if (t) {
        G(i, E)
    ...
    function Or(i) {
      ...
      do {
        if (a >>> 0 > 1083174911) {
          ...
          if ((o | 0) < 0) {
            if (!(i <= -1075)) {
              if (!(i + -4503599627370496 + 4503599627370496 != i)) {
                break
              }
      ...
      i = +ji(
        u +
          u *
            ...
            (i *
              (i *
                (i * (i * 0.0013333559164630223 + 0.009618129842126066) +
                  0.0555041086648214) +
                0.2402265069591) +
              0.6931471805599453),
        (((o & -256) | 0) / 256) | 0
    ...
    function Mr(r) {
      ...
      r =
        l *
          (r +
            (t *
              (t * (t * 0.15313837699209373 + 0.22222198432149784) +
                0.3999999999940942) +
              u *
                (t *
                  (t * (t * 0.14798198605116586 + 0.1818357216161805) +
                    0.2857142874366239) +
                  0.6666666666666735))) +
        (o - c - r)
    ...
    function An(i, e, s, r) {
      ...
      i = t ^ o
      return (
        R((Me(l, f, R(n ^ s, t ^ r, n, t) | 0, m, 0) | 0) ^ e, m ^ i, e, i) | 0
      )
    }
    function Tn(i, r, f, n) {
      i = i | 0
    ...
    function Nn(r, i, e, t) {
      ...
      e = m
      return (
        ((m = ((s(i, o) | 0) + (s(t, n) | 0) + e) | (e & 0)), r | 0 | 0) | 0
      )
    }
    function se(e, r, i, t) {
      e = e | 0
  ...
  const _lame_set_brate = (Module._lame_set_brate = asm._lame_set_brate)
  const _lame_encode_buffer_ieee_float = (Module._lame_encode_buffer_ieee_float =
    asm._lame_encode_buffer_ieee_float)
  const runPostSets = (Module.runPostSets = asm.runPostSets)
  const _lame_close = (Module._lame_close = asm._lame_close)
  const _lame_set_in_samplerate = (Module._lame_set_in_samplerate =
    asm._lame_set_in_samplerate)
  var _i64Add = (Module._i64Add = asm._i64Add)
  const _lame_set_num_channels = (Module._lame_set_num_channels =
    asm._lame_set_num_channels)
  var _strlen = (Module._strlen = asm._strlen)
  var _memset = (Module._memset = asm._memset)
  var _malloc = (Module._malloc = asm._malloc)
  const _lame_set_mode = (Module._lame_set_mode = asm._lame_set_mode)
  var _memcpy = (Module._memcpy = asm._memcpy)
  const _lame_init = (Module._lame_init = asm._lame_init)
  var _bitshift64Lshr = (Module._bitshift64Lshr = asm._bitshift64Lshr)
  var _free = (Module._free = asm._free)
  const _lame_init_params = (Module._lame_init_params = asm._lame_init_params)
  const _lame_encode_flush = (Module._lame_encode_flush =
    asm._lame_encode_flush)
  var _bitshift64Shl = (Module._bitshift64Shl = asm._bitshift64Shl)
  const dynCall_iiii = (Module.dynCall_iiii = asm.dynCall_iiii)
  const dynCall_iiiii = (Module.dynCall_iiiii = asm.dynCall_iiiii)
  const dynCall_vii = (Module.dynCall_vii = asm.dynCall_vii)
  const dynCall_iii = (Module.dynCall_iii = asm.dynCall_iii)
  const dynCall_viiii = (Module.dynCall_viiii = asm.dynCall_viiii)
  ...
  var i64Math = (function() {
    ...
    e.math.Long.fromInt = function(r) {
      if (-128 <= r && r < 128) {
        const i = e.math.Long.IntCache_[r]
        if (i) {
          return i
        }
      }
      const t = new e.math.Long(r | 0, r < 0 ? -1 : 0)
      if (-128 <= r && r < 128) {
    ...
    e.math.Long.fromString = function(r, s) {
      ...
      const f = e.math.Long.fromNumber(Math.pow(i, 8))
      let t = e.math.Long.ZERO
      for (let n = 0; n < r.length; n += 8) {
        const o = Math.min(8, r.length - n)
        const a = parseInt(r.substring(n, n + o), i)
        if (o < 8) {
          const l = e.math.Long.fromNumber(Math.pow(i, o))
    ...
    e.math.Long.prototype.toString = function(l) {
      ...
      if (this.isNegative()) {
        if (this.equals(e.math.Long.MIN_VALUE)) {
          const o = e.math.Long.fromNumber(r)
          const a = this.div(o)
      ...
      const s = e.math.Long.fromNumber(Math.pow(r, 6))
      var i = this
      let n = ''
      while (true) {
        const f = i.div(s)
        const u = i.subtract(f.multiply(s)).toInt()
        let t = u.toString(r)
        i = f
        if (i.isZero()) {
          return t + n
    ...
    e.math.Long.prototype.getNumBitsAbs = function() {
      if (this.isNegative()) {
        ...
        const i = this.high_ != 0 ? this.high_ : this.low_
        for (var r = 31; r > 0; r--) {
          if ((i & (1 << r)) != 0) {
            break
          }
    ...
    e.math.Long.prototype.add = function(t) {
      const s = this.high_ >>> 16
      const d = this.high_ & 65535
      const c = this.low_ >>> 16
      const u = this.low_ & 65535
      const a = t.high_ >>> 16
      const h = t.high_ & 65535
      const f = t.low_ >>> 16
      const l = t.low_ & 65535
      let o = 0,
        i = 0,
        r = 0,
        n = 0
    ...
    e.math.Long.prototype.multiply = function(r) {
      ...
      if (
        ...
        r.lessThan(e.math.Long.TWO_PWR_24_)
      ) {
        return e.math.Long.fromNumber(this.toNumber() * r.toNumber())
      }
      const d = this.high_ >>> 16
      const u = this.high_ & 65535
      const l = this.low_ >>> 16
      const o = this.low_ & 65535
      const h = r.high_ >>> 16
      const c = r.high_ & 65535
      const f = r.low_ >>> 16
      const s = r.low_ & 65535
      let n = 0,
        i = 0,
        t = 0,
        a = 0
    ...
    e.math.Long.prototype.div = function(r) {
      ...
      let a = e.math.Long.ZERO
      var t = this
      while (t.greaterThanOrEqual(r)) {
        var i = Math.max(1, Math.floor(t.toNumber() / r.toNumber()))
        const s = Math.ceil(Math.log(i) / Math.LN2)
        const u = s <= 48 ? 1 : Math.pow(2, s - 48)
        let n = e.math.Long.fromNumber(i)
        let o = n.multiply(r)
    ...
    const m = { appName: 'Modern Browser' }
    let o
    const D = 0xdeadbeefcafe
    const w = (D & 16777215) == 15715070
    function r(e, r, i) {
      if (e != null) {
        if ('number' == typeof e) {
          this.fromNumber(e, r, i)
        } else if (r == null && 'string' != typeof e) {
    ...
    function h(r, i) {
      const e = l[r.charCodeAt(i)]
      return e == null ? -1 : e
    }
    function j(r) {
      for (let e = this.t - 1; e >= 0; --e) {
        r[e] = this[e]
      }
      r.t = this.t
      r.s = this.s
    ...
    function se(n, e) {
      ...
      const a = (1 << t) - 1
      e[0] = this[r] >> t
      for (let i = r + 1; i < this.t; ++i) {
        e[i - r - 1] |= (this[i] & a) << o
        e[i - r] = this[i] >> t
      }
      if (t > 0) {
        e[this.t - r - 1] |= (this.s & a) << o
      }
      e.t = this.t - r
      e.clamp()
    }
    ...
    function L(i) {
      ...
      for (e = 0; e < r.t - 1; ++e) {
        const t = r.am(e, r[e], i, 2 * e, 0, 1)
        if (
          (i[e + r.t] += r.am(e + 1, 2 * r[e], i, 2 * e + 1, t, r.t - e - 1)) >=
          r.DV
        ) {
          i[e + r.t] -= r.DV
          i[e + r.t + 1] = 1
    ...
    function C(_, a, e) {
      ...
      const w = h * (1 << this.F1) + (n > 1 ? i[n - 2] >> this.F2 : 0)
      const E = this.FV / w,
        v = (1 << this.F1) / w,
        S = 1 << this.F2
      let f = e.t,
      ...
      while (--u >= 0) {
        let c =
          e[--f] == h ? this.DM : Math.floor(e[f] * E + (e[f - 1] + S) * v)
    ...
    function B(i) {
      ...
      if (this.s < 0 && e.compareTo(r.ZERO) > 0) {
        i.subTo(e, e)
      }
      return e
    }
    ...
    function K(e) {
      ...
      for (let i = 0; i < this.m.t; ++i) {
        ...
        const t =
          (r * this.mpl +
            (((r * this.mph + (e[i] >> 15) * this.mpl) & this.um) << 15)) &
          e.DM
        r = i + this.m.t
    ...
    function ne(e) {
      ...
      const s = this.chunkSize(e)
      const o = Math.pow(e, s)
      let a = c(o),
        r = t(),
        i = t(),
        n = ''
    ...
    var i = {
      ...
      stringify: function(o, a, s) {
        let t = new e.math.Long(o, a).toString()
        if (s && t[0] == '-') {
          i.ensureTemps()
          const n = new r()
          n.fromString(t, 10)
      ...
      fromString: function(h, l, d, c, u) {
        ...
        const s = e.math.Long.fromString(t.toString())
  ...
  if (memoryInitializer) {
    ...
    if (ENVIRONMENT_IS_NODE || ENVIRONMENT_IS_SHELL) {
      ...
      const applyMemoryInitializer = function(e) {
        if (e.byteLength) {
          e = new Uint8Array(e)
        }
      ...
      const request = Module.memoryInitializerRequest
      if (request) {
        if (request.response) {
          setTimeout(function() {
  ...
  Encoder.prototype.encode = function(i) {
    ...
    for (let e = 0; e < NUM_CH; ++e) {
      this.srcBuf[e].set(i[e])
    }
    const t = lame_encode_buffer_ieee_float(
      this.gfp,
      this.srcPtr[0],
      this.srcPtr[1],
      r,
  ...
  Encoder.prototype.finish = function(e) {
    const r = lame_encode_flush(this.gfp, this.dstPtr, this.dstSz)
    this.mp3Buffers.push(new Uint8Array(this.dstBuf.subarray(0, r)))
    const i = new Blob(this.mp3Buffers, { type: e || 'audio/mpeg' })
    this.cleanup()
    return i
  }
  ...
  Encoder.prototype.allocBuffers = function(r) {
    ...
    for (let e = 0; e < NUM_CH; ++e) {
      ...
      this.srcBuf[e] = new Float32Array(
        HEAPU8.buffer,
        this.srcPtr[e],
        this.srcLen
      )
