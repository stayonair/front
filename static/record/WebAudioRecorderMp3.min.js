  ...
  ;(function() {
    ...
    function parseJSFunc(r) {
      const e = r
        ...
        .slice(1)
      return {
 arguments: e[0], body: e[1], returnValue: e[2] 
}
    }
    const JSsource = {}
  ...
  var MEMFS = {
    ...
    getFileDataAsRegularArray: function(e) {
      if (e.contents && e.contents.subarray) {
        const i = []
        for (let r = 0; r < e.usedBytes; ++r) {i.push(e.contents[r])}
        return i
      }
      return e.contents
    },
 ...
 type: 'remote', db: t, entries: r 
  ...
  var FS = {
    ...
    mount: function(o, s, r) {
      ...
      const i = {
 type: o, opts: s, mountpoint: r, mounts: [] 
}
      const t = o.mount(i)
      t.mount = i
      i.root = t
    ...
    createDataFile: function(r, a, e, u, l, f) {
      ...
      if (e) {
        if (typeof e === 'string') {
          ...
          for (let i = 0, c = e.length; i < c; ++i) {s[i] = e.charCodeAt(i)}
          e = s
        }
        FS.chmod(t, n | 146)
        const o = FS.open(t, 'w')
  ...
  var SOCKFS = {
    ...
    websocket_sock_ops: {
      createPeer: function(t, r, n) {
        ...
        const a = {
 addr: r, port: n, socket: e, dgram_send_queue: [] 
}
      ...
      handlePeerEvents: function(r, e) {
        ...
        function n(t) {
          ...
          r.recv_queue.push({
 addr: e.addr, port: e.port, data: t 
})
      ...
      recvmsg: function(r, s) {
        ...
        const f = {
 buffer: new Uint8Array(a, o, t), addr: e.addr, port: e.port 
}
        if (r.type === 1 && t < n) {
          const l = n - t
  ...
  const _lame_encode_buffer_ieee_float = (Module._lame_encode_buffer_ieee_float = asm._lame_encode_buffer_ieee_float)
  ...
  const _lame_init_params = (Module._lame_init_params =
    asm._lame_init_params)
  ...
  var i64Math = (function() {
    ...
    function j(r) {
      for (let e = this.t - 1; e >= 0; --e) {r[e] = this[e]}
      r.t = this.t
      r.s = this.s
    }
    function E(e) {
    ...
    function A(r, i) {
      for (let e = r; e < this.t; ++e) {i[e - r] = this[e]}
  ...
  Encoder.prototype.encode = function(i) {
    ...
    for (let e = 0; e < NUM_CH; ++e) {this.srcBuf[e].set(i[e])}
  ...
  Encoder.prototype.freeBuffers = function() {
    ...
    delete this.srcBuf
    free(this.dstPtr)
    for (let e = 0; e < NUM_CH; ++e) {free(this.srcPtr[e])}
    delete this.dstPtr
    delete this.srcPtr
  }
